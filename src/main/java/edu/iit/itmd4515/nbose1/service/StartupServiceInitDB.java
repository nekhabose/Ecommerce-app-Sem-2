 ...
 */
package edu.iit.sat.itmd4515.nbose1.sampleservice;


import edu.iit.itmd4515.nbose1.security.Group;
import edu.iit.itmd4515.nbose1.security.GroupService;
import edu.iit.itmd4515.nbose1.security.User;
import edu.iit.itmd4515.nbose1.security.UserService;
import edu.iit.itmd4515.nbose1.service.ApptService;
import edu.iit.itmd4515.nbose1.service.OwnerService;
import edu.iit.itmd4515.nbose1.service.PetService;
import edu.iit.itmd4515.nbose1.service.SpecilizationService;
import edu.iit.itmd4515.nbose1.service.VetService;
...
public class StartupServiceInitDB {
    ...
    private void postConstruct(){
        ...
        Group vetGroup = new Group("VET_GROUP", "Group of vet doctors");
        ...
        User vet1 = new User("vet1", "vet1");
        vet1.addGroup(vetGroup);
        vet1.addGroup(adminGroup);
        
        User vet2 = new User("vet2", "vet2");
        vet2.addGroup(vetGroup);
        vet2.addGroup(ownerGroup);
        
        User vet3 = new User("vet3", "vet3");
